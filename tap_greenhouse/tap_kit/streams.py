...
class Stream:
    ...
    # def _build_metadata_field(self, meta, stream, field):
    #     print(stream)
    #     print(field)
    #     if field and field in self.__dict__:
    #         return singer.metadata.write(meta, (), stream, self.__dict__[field])

    # def load_metadata(self):
    #     schema = self.schema()
    #     meta = singer.metadata.new()
    #
    #     for k, v in _META_FIELDS.items():
    #         self._build_metadata_field(meta, k, v)
    #
    #     for field_stream in schema['properties'].keys():
    #         if field_stream in _META_FIELDS.keys():
    #             meta = singer.metadata.write(meta, ('properties', field_stream), 'inclusion', 'automatic')
    #         else:
    #             meta = singer.metadata.write(meta, ('properties', field_stream), 'inclusion', 'available')
    #
    #     return singer.metadata.to_list(meta)
